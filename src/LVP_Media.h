...
namespace LibVoyaPlayer
{
	namespace MediaPlayer
	{
		...
		public:
			...
			static std::unordered_map<std::string, std::string> GetMediaCodecMeta(LibFFmpeg::AVStream* stream);
			...
			static std::unordered_map<std::string, std::string> GetMediaMeta(LibFFmpeg::AVFormatContext* formatContext);
			static std::unordered_map<std::string, std::string> GetMediaTrackMeta(LibFFmpeg::AVStream* stream);
		...
		private:
			...
			static std::unordered_map<std::string, std::string> getMeta(LibFFmpeg::AVDictionary* metadata);
